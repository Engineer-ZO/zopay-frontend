    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link href="/admin/fees/withdrawals" className="group">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md hover:border-deep-blue-violet-500 transition-all cursor-pointer">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-deep-blue-violet-50 text-deep-blue-violet-600 rounded-xl">
                <CreditCard className="w-6 h-6" />
              </div>
              <ArrowRight className="w-5 h-5 text-gray-300 group-hover:text-deep-blue-violet-500 group-hover:translate-x-1 transition-all" />
            </div>
