...
export default function ReportsPage() {
    ...
    const StatusBadge = ({ status }: { status: ReportJob['status'] }) => {
        const styles = {
            ...
            PENDING: "bg-crimson-red-100 text-crimson-red-800",
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                        <TrendingUp className="w-8 h-8 text-deep-blue-violet-600" />
                        Reports & Exports
                    </h1>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-deep-blue-violet-600 rounded-lg text-sm font-medium hover:bg-deep-blue-violet-700 text-white"
                    >
            ...
            {isLoadingSummary ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-xl border border-deep-blue-violet-200 bg-deep-blue-violet-50">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="p-2 bg-deep-blue-violet-100 text-deep-blue-violet-600 rounded-lg">
                                <Building2 className="w-5 h-5" />
                            </div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-deep-blue-violet-700 opacity-80">Total Merchants</p>
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900">{platformSummary.totalMerchants}</h3>
                        <p className="text-xs text-deep-blue-violet-600 mt-1">
                    ...
                    <div className="p-4 rounded-xl border border-crimson-red-200 bg-crimson-red-50">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="p-2 bg-crimson-red-100 text-crimson-red-600 rounded-lg">
                                <DollarSign className="w-5 h-5" />
                            </div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-crimson-red-700 opacity-80">Platform Revenue</p>
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900">
                        ...
                        <p className="text-xs text-crimson-red-600 mt-1">Total fees collected</p>
                    </div>
                </div>
            ) : null}
                                    ...
                                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-4 py-3 text-right">
                                            <span className={`text-sm font-semibold ${
                                                ...
                                                gateway.successRate >= 90 ? 'text-deep-blue-violet-600' :
                ...
                <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-white">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search..."
                                    className="pl-9 pr-3 py-1.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-deep-blue-violet-500 focus:border-deep-blue-violet-500 outline-none text-sm w-48"
                                />
                            </div>
                        </div>
                                        ...
                                        <tr key={report.id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${report.format === 'XLSX' ? 'bg-green-100 text-green-600' :
                                                            report.format === 'PDF' ? 'bg-red-100 text-red-600' :
                                                                'bg-deep-blue-violet-100 text-deep-blue-violet-600'
                                                        }`}>
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                <button
                                                    ...
                                                    className="p-1.5 text-gray-400 hover:text-deep-blue-violet-600 hover:bg-deep-blue-violet-50 rounded-lg transition-colors disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-gray-400"
                                                >
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                { title: "Transaction Master", desc: "Full dump of all transactions.", icon: Layout, color: "deep-blue-violet" },
                                ...
                                { title: "API Usage Log", desc: "Dev environment activity.", icon: FileCode, color: "crimson-red" }
                            ].map((tmpl, i) => (
                                <button key={i} className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 hover:border-deep-blue-violet-300 hover:bg-deep-blue-violet-50 transition-all text-left group bg-white">
                                    <div className={`p-2 rounded-lg bg-${tmpl.color}-50 text-${tmpl.color}-600 shrink-0`}>
                                        <tmpl.icon className="w-5 h-5" />
                                    </div>
                                    <div>
                                        <h4 className="text-sm font-medium text-gray-900 group-hover:text-deep-blue-violet-700">{tmpl.title}</h4>
                ...
                <div className="space-y-6">
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button className="text-xs font-medium text-deep-blue-violet-600 hover:text-deep-blue-violet-700">Manage</button>
                        </div>
                    ...
                    <div className="bg-deep-blue-violet-50 rounded-xl border border-deep-blue-violet-100 p-4">
                        <div className="flex items-start gap-3">
                            <ShieldCheck className="w-5 h-5 text-deep-blue-violet-600 shrink-0 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-bold text-deep-blue-violet-900">Pro Tip</h4>
                                <p className="text-xs text-deep-blue-violet-800 mt-1 leading-relaxed">
                            ...
                            <div className="p-6 space-y-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-deep-blue-violet-500 outline-none"
                                    >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-deep-blue-violet-500 outline-none">
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 flex items-center gap-3">
                                    ...
                                    <input type="checkbox" defaultChecked className="ml-auto rounded border-gray-300 text-deep-blue-violet-600 focus:ring-deep-blue-violet-500" />
                                </div>
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <button
                                        onClick={() => setIsCreateModalOpen(false)}
                                        className="flex-1 px-4 py-2 bg-deep-blue-violet-600 text-white font-medium rounded-lg hover:bg-deep-blue-violet-700 text-sm"
                                    >
                                        Generate Report
                                    </button>
                                </div>
