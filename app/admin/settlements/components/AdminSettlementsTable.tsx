...
export function AdminSettlementsTable({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "PROCESSING":
        return "bg-deep-blue-violet-100 text-deep-blue-violet-700";
      case "FAILED":
          ...
          <tbody className="divide-y divide-gray-50">
            {settlements.map((settlement) => (
              ...
              >
                ...
                <td className="px-4 py-2.5 text-xs font-semibold text-deep-blue-violet-600">
                  ...
                  <div className="flex items-center justify-end gap-1.5">
                    {settlement.status === "COMPLETED" && settlement.statementUrl && (
                      <button
                        ...
                        className="px-2 py-1 text-xs font-medium text-crimson-red-600 hover:text-crimson-red-700 hover:bg-crimson-red-50 rounded transition-colors flex items-center gap-1"
                      >
                    ...
                    <button
                      ...
                      className="px-2 py-1 text-xs font-medium text-deep-blue-violet-600 hover:text-deep-blue-violet-700 hover:bg-deep-blue-violet-50 rounded transition-colors flex items-center gap-1"
                    >
