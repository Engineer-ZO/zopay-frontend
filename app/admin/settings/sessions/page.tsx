    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Manage your active admin login sessions across all devices
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-medium text-red-800 dark:text-red-200 text-sm">Admin Security Notice</h3>
            <p className="text-xs text-red-700 dark:text-red-300 mt-1">
              As an admin user, your sessions have elevated privileges. Regularly review and terminate unfamiliar sessions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-foreground">
            Your Active Admin Sessions ({sessions.length})
          </h2>
          <button
            type="button"
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-background rounded-2xl p-6 shadow-2xl border border-border max-w-md w-full">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Logout from all admin devices?</h3>
                <p className="text-xs text-muted-foreground mt-1">
                  This will terminate all your active admin sessions, including this one.
                </p>
              </div>
            </div>
            ...
            <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 rounded-lg p-3 mb-4">
              <p className="text-xs text-red-700 dark:text-red-300">
                <strong>Important:</strong> You will be immediately logged out from all admin dashboards and will need to sign in again.
              </p>
            </div>
