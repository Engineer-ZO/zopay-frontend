...
export default function IntroductionPage() {
    return (
        <div>
            ...
            <p className="mb-6">
                ZoPay provides a unified payment orchestration API to integrate mobile money payments across Cameroon into your applications, supporting both MTN Mobile Money and Orange Money with real-time transaction monitoring and comprehensive financial management.
            </p>

            <h2>What is ZoPay?</h2>
            <p>
                ZoPay is a comprehensive payment orchestration platform that simplifies the integration of MTN Mobile Money and Orange Money services. Designed for secure money movement and high-volume transaction processing, ZoPay is built specifically for businesses operating in Cameroon.
            </p>
            <p>
                Whether you're building an e-commerce platform, a mobile app, or a web service, ZoPay provides the tools you need to handle payments efficiently and securely.
            </p>
            ...
            <p>
                Once you have a ZoPay account, you'll have access to the sandbox environment where you can test your integration before going live.
            </p>
            ...
            <ul>
                <li>
                    ...
                    </Link> - Learn how to set up and configure your ZoPay integration
                </li>
                <li>
